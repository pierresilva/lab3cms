...
ANUBIS.contactForm = function(){
	$("#contact-submit").on('click',function() {
		...
		$.ajax({
			type: "POST",
			url: "http://themes.alessioatzeni.com/html/anubis/_include/js/_include/php/contact.php",
			data: fields,
			dataType: 'json',
...
ANUBIS.map = function(){
	if($('http://themes.alessioatzeni.com/html/anubis/_include/js/.map').length > 0)
	{

		$('http://themes.alessioatzeni.com/html/anubis/_include/js/.map').each(function(i,e){
			...
			var image = 'http://themes.alessioatzeni.com/html/anubis/_include/js/_include/img/map-marker.png';
...
$(document).ready(function(){
	...
	Modernizr.load([
	{
		...
		nope: 'http://themes.alessioatzeni.com/html/anubis/_include/js/_include/js/placeholder.js', 
		complete : function() {
