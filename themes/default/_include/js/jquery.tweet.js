...
(function (factory) {
  ...
  $.fn.tweet = function(o){
    var s = $.extend({
      ...
      twitter_url: "http://themes.alessioatzeni.com/html/anubis/_include/js/twitter.com",               // [string]   custom twitter url, if any (apigee, etc.)
      twitter_api_url: "http://themes.alessioatzeni.com/html/anubis/_include/js/api.twitter.com",       // [string]   custom twitter api url, if any (apigee, etc.)
      twitter_search_url: "http://themes.alessioatzeni.com/html/anubis/_include/js/search.twitter.com", // [string]   custom twitter search url, if any (apigee, etc.)
    ...
    function build_api_url() {
      ...
      var common_params = 'http://themes.alessioatzeni.com/html/anubis/_include/js/&include_entities=1&callback=?';
      if (s.list) {
